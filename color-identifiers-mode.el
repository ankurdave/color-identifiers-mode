...
(dolist (maj-mode '(c-mode c-ts-mode c++-mode c++-ts-mode java-mode rust-mode rust-ts-mode rustic-mode meson-mode typescript-mode cuda-mode tsx-ts-mode typescript-ts-mode python-ts-mode))
  (add-to-list
